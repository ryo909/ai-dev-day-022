import './style.css';
const PROFILE = {"day":"Day022","title":"Idea Combo Deck","one_sentence":"制約付きのアイデア探索をカード操作で進める組み合わせツール。（話題:GitHub Trending (A）","core_action":"combine","family":"idea_cards","mechanic":"card_pairing","input_style":"multi_select_tokens","output_style":"card_stack","audience_promise":"faster_idea_filtering","publish_hook":"失敗案を除外しながら次案を出す","engine":"card_mixer","interaction_archetype":"card_deck_recombination","page_archetype":"deck_stage","output_shape":"stacked_cards","state_model":"deck_history_with_lock","core_loop":"draw -> reject -> redraw","component_pack":"deck_controls+history_panel","scaffold_id":"card_deck_board","single_shot_text_generator":false};
